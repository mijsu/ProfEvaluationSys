    ...
    <header style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '8px' : '14px', flex: 1, minWidth: 0 }}>
        ...
        <div style={{ 
          ...
          borderRadius: '50%', 
          background: 'radial-gradient(circle, #d4a843 0%, #b8932e 40%, #8b6e1a 100%)', 
          display: 'flex', 
          alignItems: 'center', 
          justifyContent: 'center', 
          fontSize: '10px', 
          ...
          <img src="/favicon.png" alt="CTT" style={{ width: isMobile ? '28px' : '42px', height: isMobile ? '28px' : '42px', borderRadius: '50%' }} />
        </div>
        <div>
          <h1 style={{ 
